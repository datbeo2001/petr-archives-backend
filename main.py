...
from uploadCloudinary import cloudinaryUpload
...
def create_new_sticker(file: UploadFile = File(...), name: str = Form(""), timestamp: str = Form(""),
    ...
    try:
        ...
        stickerDict = {"name": name.title(), "image_link": url, "timestamp": timestamp, "location": location.title(),
                       "instagram": f"http://www.instagram.com/{instagram}"}
